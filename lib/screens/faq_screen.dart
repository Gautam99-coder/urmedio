    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          // --- FAQ List Section ---
          // We use ListView.separated to build the list with dividers
          ListView.separated(
            shrinkWrap: true, // Important to use inside a scrollable parent
            physics:
            ...
            itemBuilder: (context, index) {
              ...
              return ExpansionTile(
                ...
                // Custom styling for the expansion tile
